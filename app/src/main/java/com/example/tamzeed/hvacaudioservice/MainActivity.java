    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        try {
            ...
            if(flag==true)
            {
                ...
                String str= currentDateandTime+" "+Constants.temperature+"  "+Constants.humidity+" " +Constants.acceloString+"  "+Constants.magnet;
